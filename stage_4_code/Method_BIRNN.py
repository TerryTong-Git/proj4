...
class Method_BIRNN(method, nn.Module):
    data = None
    ...
    def __init__(self, input_size, hidden_size, output_size, num_layers):
        ...
        self.rnn = nn.RNN(input_size, hidden_size, batch_first=True, num_layers=10,bidirectional=True) ##try with LSTM and GRU
    ...
    def forward(self, x):
        batch_size = x.size(0)
        h0 = torch.zeros(10*2, batch_size, self.hidden_size).cuda()
        # print(h0.size())
    ...
    def test(self, X):
        ...
        # I need to run a dataloader and collate info...
